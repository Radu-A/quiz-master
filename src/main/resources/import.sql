...
-- Temáticas
-- ============================================================
INSERT INTO tematicas (id, nombre, descripcion) VALUES (1, 'Cibercultura y Frikismo', 'Desde las entrañas del código y la historia hacker hasta los secretos mejor guardados del cine, la literatura y los videojuegos.');
INSERT INTO tematicas (id, nombre, descripcion) VALUES (2, 'Biología Extrema', 'Criaturas indestructibles, mecanismos de defensa letales, venenos exóticos y rarezas de la flora y fauna mundial.');
INSERT INTO tematicas (id, nombre, descripcion) VALUES (3, 'Paradojas Cósmicas', 'Viajes en el tiempo, física cuántica, agujeros negros y experimentos mentales que desafían la lógica humana.');
INSERT INTO tematicas (id, nombre, descripcion) VALUES (4, 'Legalmente Absurdo', 'Normas vigentes, prohibiciones extrañas y leyes históricas de distintos países que parecen una auténtica broma.');
INSERT INTO tematicas (id, nombre, descripcion) VALUES (5, 'Manual de Supervivencia', 'Qué hacer en situaciones límite, cómo sobrevivir a la naturaleza salvaje y los peligros ocultos en la gastronomía extrema.');
